# using dynamic prompts in openai file

system_prompt_media = "give me only [{media}] questions related answers"

linkedin_post_generator_prompt = """Act as if you're a social media expert.
Give me a 10 linkedin posts about [{topic}].
The post should be optimised for vitality and contain hashtags and emoticons.
Each post should not exceed 280 characters in length.
"""
